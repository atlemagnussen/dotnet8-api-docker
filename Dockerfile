...
RUN dotnet build "./TestWebApiNet8Docker.csproj" -c $BUILD_CONFIGURATION -o /app/build

FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./TestWebApiNet8Docker.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
